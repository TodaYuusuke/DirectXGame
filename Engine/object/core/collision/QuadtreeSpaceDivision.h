...
namespace LWP::Object {
	...
	private: // ** プライベートなメンバ関数 ** //
		...
		LWP::Math::Vector2 GetMin() { return centerPosition - LWP::Math::Vector2{ spaceSize,spaceSize }; }
		/// <summary>
		/// 空間の最大地点を取得する関数
		/// </summary>
		/// <returns>空間のmax座標</returns>
		LWP::Math::Vector2 GetMax() { return centerPosition + LWP::Math::Vector2{ spaceSize,spaceSize }; }
		/// <summary>
		/// 最小の空間サイズを取得する関数
		/// </summary>
		/// <returns>空間のmax座標</returns>
